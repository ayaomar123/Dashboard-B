            ...
            <div class="card-content p-2">
                ...
                <form action="{{route('register')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative has-icon-right">
                            <input name="email" type="text" id="exampleInputEmailId" class="form-control input-shadow"
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative has-icon-right">
                            <input name="passworf" type="text" id="exampleInputPassword" class="form-control input-shadow"
